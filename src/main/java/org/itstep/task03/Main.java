 ...
 * Задание 3
 *
 * 1) Создайте класс EmployeeAndChild
 * 2) Добавьте логическое поле hasChild
 * 3) Добавьте дополнительный конструктор, который помимо ФИО, вида оплаты и суммы принимает
 * есть ли дети у сотрудника
 * 4) Добавить геттеры и сеттеры для поля hasChild
 * 5) Раскомментируйте код в методе main()
 *
